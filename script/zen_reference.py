...
try:
    ...
    js('window.referenceSplitA=gBrowser.selectedTab;window.referenceSplitB=gBrowser.addTab("http://127.0.0.1:8765/second.html",{triggeringPrincipal:Services.scriptSecurityManager.getSystemPrincipal()});')
    time.sleep(2)
    snap('09-split','gZenViewSplitter.splitTabs([window.referenceSplitA,window.referenceSplitB],"grid");')
